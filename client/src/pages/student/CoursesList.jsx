...
const CoursesList = () => {
  ...
  const { allCourses, navigate, backendUrl, getToken, recommendations, fetchRecommendations } = useContext(AppContext)
  ...
  return (
    <>
      <div className="relative md:px-36 px-8 pt-20 text-left">
        ...
        {recommendations && recommendations.length > 0 && (
          <div className="my-16">
            ...
            {recommendations && recommendations.length > 0 ? (
              ...
              <p className="text-gray-500">No personalized recommendations yet. Explore courses below!</p>
            )}
          </div>
        )}
        ...
        {/* ✅ Normal Course List */}
        <div className="my-16">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800">Courses You Might Like</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 px-2 md:p-0">
